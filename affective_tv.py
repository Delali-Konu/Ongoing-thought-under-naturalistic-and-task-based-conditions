...
df = pd.read_csv('R:\\Task_SGT\\Bronte\\movie_study_2.0\\references\\sorted_filmList.csv')
...
df_final.to_csv('R:\\Task_SGT\\Bronte\\movie_study_2.0\\references\\filmList.csv', index = False)
